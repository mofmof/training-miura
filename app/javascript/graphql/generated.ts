...
export type Mutation = {
  ...
  removeLabelToTask?: Maybe<RemoveLabelToTaskPayload>;
...
export type MutationRemoveLabelToTaskArgs = {
  input: RemoveLabelToTaskInput;
};
...
/** Autogenerated input type of RemoveLabelToTask */
export type RemoveLabelToTaskInput = {
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']>;
  labelId: Scalars['ID'];
  taskId: Scalars['ID'];
...
/** Autogenerated return type of RemoveLabelToTask */
export type RemoveLabelToTaskPayload = {
  __typename?: 'RemoveLabelToTaskPayload';
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']>;
  taskLabel: TaskLabel;
};
...
export type RemoveLabelToTaskMutationVariables = Exact<{
  taskId: Scalars['ID'];
  labelId: Scalars['ID'];
}>;


export type RemoveLabelToTaskMutation = { __typename?: 'Mutation', removeLabelToTask?: { __typename?: 'RemoveLabelToTaskPayload', taskLabel: { __typename?: 'TaskLabel', id: string } } | null };
...
export const RemoveLabelToTaskDocument = gql`
  ...
  removeLabelToTask(input: {taskId: $taskId, labelId: $labelId}) {
    ...
    `;
export type RemoveLabelToTaskMutationFn = Apollo.MutationFunction<RemoveLabelToTaskMutation, RemoveLabelToTaskMutationVariables>;

/**
 * __useRemoveLabelToTaskMutation__
 *
 * To run a mutation, you first call `useRemoveLabelToTaskMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useRemoveLabelToTaskMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [removeLabelToTaskMutation, { data, loading, error }] = useRemoveLabelToTaskMutation({
 *   variables: {
 *      taskId: // value for 'taskId'
 *      labelId: // value for 'labelId'
 *   },
 * });
 */
export function useRemoveLabelToTaskMutation(baseOptions?: Apollo.MutationHookOptions<RemoveLabelToTaskMutation, RemoveLabelToTaskMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<RemoveLabelToTaskMutation, RemoveLabelToTaskMutationVariables>(RemoveLabelToTaskDocument, options);
      }
export type RemoveLabelToTaskMutationHookResult = ReturnType<typeof useRemoveLabelToTaskMutation>;
export type RemoveLabelToTaskMutationResult = Apollo.MutationResult<RemoveLabelToTaskMutation>;
export type RemoveLabelToTaskMutationOptions = Apollo.BaseMutationOptions<RemoveLabelToTaskMutation, RemoveLabelToTaskMutationVariables>;
