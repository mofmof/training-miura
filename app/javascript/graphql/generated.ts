...
export type TaskSearchTitleQueryVariables = Exact<{
  title: Scalars['String'];
}>;


export type TaskSearchTitleQuery = { __typename?: 'Query', taskSearchTitle: Array<{ __typename?: 'Task', id: string, title: string, body?: string | null, state: TaskStateEnum, limitOn?: any | null }> };
...
export const TaskSearchTitleDocument = gql`
    query taskSearchTitle($title: String!) {
  taskSearchTitle(title: $title) {
    id
    title
    body
    state
...
/**
 * __useTaskSearchTitleQuery__
 *
 * To run a query within a React component, call `useTaskSearchTitleQuery` and pass it any options that fit your needs.
 * When your component renders, `useTaskSearchTitleQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useTaskSearchTitleQuery({
 *   variables: {
 *      title: // value for 'title'
 *   },
 * });
 */
export function useTaskSearchTitleQuery(baseOptions: Apollo.QueryHookOptions<TaskSearchTitleQuery, TaskSearchTitleQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<TaskSearchTitleQuery, TaskSearchTitleQueryVariables>(TaskSearchTitleDocument, options);
      }
export function useTaskSearchTitleLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<TaskSearchTitleQuery, TaskSearchTitleQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<TaskSearchTitleQuery, TaskSearchTitleQueryVariables>(TaskSearchTitleDocument, options);
        }
export type TaskSearchTitleQueryHookResult = ReturnType<typeof useTaskSearchTitleQuery>;
export type TaskSearchTitleLazyQueryHookResult = ReturnType<typeof useTaskSearchTitleLazyQuery>;
export type TaskSearchTitleQueryResult = Apollo.QueryResult<TaskSearchTitleQuery, TaskSearchTitleQueryVariables>;
